...
void draw_cissoid(cairo_t *cr, AppData *app_data) {
    ...
    if (app_data->spiral_data.current_point > 50) {
        ...
        cairo_show_text(cr, "Cissoid Spiral (r = a cos(θ) + b)");
    }
}
